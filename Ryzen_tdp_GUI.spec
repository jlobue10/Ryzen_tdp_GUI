...
cp -f %{_builddir}/Ryzen_tdp_GUI/{99-amdgpu-z1e-clock.rules,99-ryzen-tdp.rules,99-ally-mcu.rules,ryzenadj,Ryzen_tdp_GUI.desktop} $RPM_SOURCE_DIR
...
%files
/usr/lib/udev/rules.d/99-ally-mcu.rules
