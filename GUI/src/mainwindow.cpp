...
void MainWindow::on_tdp_info_pushButton_clicked()
{
    ...
    if(Secure_Boot_status_str == "SecureBoot enabled"){
        ...
        */
        ...
        tdp_display_info.append("<hr align='left' size='10'>Sustained TDP setting: ");
        ...
        tdp_display_info.append("<hr align='left' size='10'><br>Sustained TDP setting: ");
        tdp_info_disp_temp = Get_tdp_Info(tdp_value_search);
        tdp_display_info.append(tdp_info_disp_temp);
        tdp_display_info.append("</hr>");
        tdp_display_info.append("<hr align='left' size='10'><br>Fast TDP setting: ");
        tdp_info_disp_temp = Get_tdp_Info(tdp_fast_lim_value_search);
        tdp_display_info.append(tdp_info_disp_temp);
        tdp_display_info.append("</hr>");
        tdp_display_info.append("<hr align='left' size='10'><br>Fast TDP value: ");
        tdp_info_disp_temp = Get_tdp_Info(tdp_fast_value_search);
        tdp_display_info.append(tdp_info_disp_temp);
        tdp_display_info.append("</hr>");
        tdp_display_info.append("<hr align='left' size='10'><br>Slow TDP setting: ");
        tdp_info_disp_temp = Get_tdp_Info(tdp_slow_lim_value_search);
        tdp_display_info.append(tdp_info_disp_temp);
        tdp_display_info.append("</hr>");
        tdp_display_info.append("<hr align='left' size='10'><br>Slow TDP value: ");
        tdp_info_disp_temp = Get_tdp_Info(tdp_slow_value_search);
        tdp_display_info.append(tdp_info_disp_temp);
        tdp_display_info.append("</hr>");
        tdp_display_info.append("<hr align='left' size='10' style='color: green;'><br>Secure Boot Enabled</hr>");
    }else {
        tdp_display_info.append("<hr align='left' size='10'>Sustained TDP setting: ");
        tdp_info_disp_temp = Get_tdp_Info(tdp_limit_value_search);
        tdp_display_info.append(tdp_info_disp_temp);
        ...
        tdp_display_info.append(tdp_info_disp_temp);
        tdp_display_info.append("</hr>");
        tdp_display_info.append("<hr align='left' size='10' style='color: red;'><br>Secure Boot Disabled</hr>");
    }    
    tdp_display_info.append("<hr align='left' size='10'><br>AMD Pstate status: ");
    tdp_info_disp_temp = Get_tdp_Info(amd_pstate_status);
    tdp_display_info.append(tdp_info_disp_temp);
    tdp_display_info.append("</hr>");
    tdp_display_info.append("<hr align='left' size='10'><br>Scaling Driver: ");
    tdp_info_disp_temp = Get_tdp_Info(scaling_driver);
    tdp_display_info.append(tdp_info_disp_temp);
    tdp_display_info.append("</hr>");
    tdp_display_info.append("<hr align='left' size='10'><br>Scaling Governor: ");
    tdp_info_disp_temp = Get_tdp_Info(scaling_governor);
    tdp_display_info.append(tdp_info_disp_temp);
    tdp_display_info.append("</hr>");
    tdp_display_info.append("<hr align='left' size='10'><br>EPP setting in use: ");
    tdp_info_disp_temp = Get_tdp_Info(energy_performance_preference);
    tdp_display_info.append(tdp_info_disp_temp);
    tdp_display_info.append("</hr>");
    tdp_display_info.append("<hr align='left' size='10'><br>Thermal policy: ");
